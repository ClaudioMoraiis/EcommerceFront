  ...
  return (
    <section className="auth-wrap">
      <form className="card auth-card" onSubmit={handleSubmit}>
        ...
        <p className="muted">Acesse para continuar sua compra.</p>
        ...
        <div className="test-credentials">
          <p className="muted">Dica</p>
          <p className="muted">O login nao pede identificadores internos do backend.</p>
          <p className="muted">Se a API retornar o ID do usuario, o frontend salva isso automaticamente.</p>
        </div>
